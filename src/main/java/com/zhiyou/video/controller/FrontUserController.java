...
public class FrontUserController extends FrontBaseController{
	...
	/**
	 * 提交登录信息
	 * Created by zhouyc on 2017年7月19日 上午11:00:37
	 * 
	 * @return
	...
	/**
	 * 提交注册信息
	 * Created by zhouyc on 2017年7月19日 上午11:00:24
	 * 
	 * @return
	 */
	@ResponseBody
	...
	public String updateHeadPost(@RequestParam("image_file") MultipartFile image,HttpServletRequest request){
		...
		//文件的名字
		String name = "upload/"+System.currentTimeMillis()+"_head"+subfix;
		//保存文件
